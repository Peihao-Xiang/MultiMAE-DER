...
def video_audio(path, save_path):
    ...
    for class_name in os.listdir(path):
        ...
        # Combine of Face and Spectrogram
            for i in range(16):
                ...
                img = np.concatenate((video_img, audio_img), axis = 0)
...
if __name__ == '__main__':
    ...
    save_train_path = 'Data\\MEAD\\MEAD_CFAS\\train'

    path_test = 'Data\\MEAD\\MEAD\\test'
    save_test_path = 'Data\\MEAD\\MEAD_CFAS\\test'

    path_val = 'Data\\MEAD\\MEAD\\val'
    save_val_path = 'Data\\MEAD\\MEAD_CFAS\\val'
